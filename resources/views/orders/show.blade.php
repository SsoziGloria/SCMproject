                        ...
                        <table class="table table-hover align-middle">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <small class="text-muted">{{ $item->product_category ??
                            ...
                            <tfoot class="table-light">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" class="text-end">
                                        UGX {{ number_format($order->total_amount - $order->shipping_fee -
                ...
                <div class="card-body">
                    <div class="d-flex flex-wrap gap-2">
                        ...
                        <form action="{{ route('orders.mark-as-shipped', $order->id) }}" method="POST">
                            @csrf
                            @method('PATCH')
                            <button type="submit" class="btn btn-success" {{ $allItemsInStock ? '' : 'disabled' }} {{
                                $allItemsInStock ? '' : 'title=Some items are out of stock' }}>
                        ...
                        <table class="table table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-{{ $stockStatus }}">
                                            {{ $availableQuantity >= $neededQuantity ? 'OK' : ($availableQuantity > 0 ?
                                            'Low' : 'Out') }}
                                        </span>
                                    </td>
                                </tr>
                ...
                <div class="modal-body">
                    <div id="cancellationOptions" class="d-none">
                        ...
                        <div class="alert alert-danger">
                            ...
                            automatically restore stock unless you check the box below.
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="restore_inventory" value="1"
                                id="restore_inventory">
                            <label class="form-check-label" for="restore_inventory">
                                <strong>Restore shipped items to physical inventory.</strong>
                            </label>
                        </div>
                        @endif
                    </div>
...
<script>
    // Initialize ship item modal
        ...
        statusSelect.addEventListener('change', toggleCancellationOptions);
