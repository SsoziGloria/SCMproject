                            ...
                            @if($product->reviews->count() > 0)
                                <div class="mb-4">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span class="text-muted ms-2">({{ $product->reviews->count() }} @if($product->reviews->count() > 1)reviews @else review @endif)</span>
                                    </div>
                                </div>
                                            ...
                                            <div class="d-flex justify-content-between align-items-start">
                                                <div>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        @for ($i = 1; $i <= 5; $i++)
                                                            <i
                                                                class="bi bi-star{{ $i <= $review->rating ? '-fill text-warning' : '' }} small"></i>
                                                        @endfor
                                                        <span
                                                            class="text-muted ms-2 small">{{ $review->created_at->format('M d, Y') }}</span>
                                                    </div>
                                                </div>
