                    ...
                    <div class="col-md-2">
                        <div class="input-group">
                            ...
                            <select name="sort" class="form-select">
                                ...
                                <option value="expected_delivery" {{ request('sort')=='expected_delivery' ? 'selected'
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    ...
                                    @if(Auth::user()->role !== 'supplier' || Auth::user()->id ===
                                    ...
                                    @if($shipment->canBeCancelled() && !in_array($shipment->status, ['delivered',
                                    'cancelled']))
                                    <form action="{{ route('shipments.update-status', $shipment) }}" method="POST"
                                        class="d-inline">
                                        @csrf
                        ...
                        <tr>
                            <td colspan="8" class="text-center py-5">
                                <div class="d-flex flex-column align-items-center">
                                    ...
                                    <p class="text-muted">
                                        {{ request()->has('search') ? 'Try a different search term or filter' : 'Create
                                        your first shipment to get started' }}
