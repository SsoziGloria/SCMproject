                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="mb-1 pt-2">Good {{ now()->format('A') === 'AM' ? 'morning' : 'afternoon' }},
                                {{ Auth::user()->name }}!</h4>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="activity">
                        ...
                        $message = "Your order <strong>{$order->order_number}</strong> has been shipped and is on its
                        way!";
                        ...
                        <div class="activity-item d-flex">
                            ...
                            <i class='bi bi-circle-fill activity-badge {{ $update["badgeClass"] }}
                                align-self-start'></i>
