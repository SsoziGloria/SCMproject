        ...
        <section>
            ...
            <ul class="space-y-2">
                ...
                <li class="w-full flex items-center p-5">
                    ...
                    <span class="w-full text-start">
                        <h5 class="font-medium">@lang('wirechat::chat.group.permisssions.actions.send_messages.label')
                        </h5>
                    </span>
                ...
                <li class="w-full flex items-center p-5">
                    ...
                    <span class="w-full text-start">
                        <h5 class="font-medium">
                            @lang('wirechat::chat.group.permisssions.actions.add_other_members.label')</h5>
                    </span>
