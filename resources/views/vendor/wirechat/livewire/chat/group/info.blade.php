<div id="group-info-modal" class="bg-[var(--wc-light-primary)] dark:bg-[var(--wc-dark-primary)]     min-h-screen">
    ...
    <section
        class="cursor-pointer flex gap-4 z-10  items-center p-3 sticky top-0 bg-[var(--wc-light-primary)] dark:bg-[var(--wc-dark-primary)]  ">
        <button wire:click="$dispatch('closeChatDrawer')" class="focus:outline-hidden cursor-pointer"> <svg
                class="w-7 h-7" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8"
                stroke="currentColor">
            ...
            <div @dusk="edit_group_information_section" class="flex  flex-col items-center gap-4 py-4  px-4    ">
                ...
                <section class="mx-auto items-center justify-center grid">
                    <div @dusk="edit_avatar_label" class="relative  h-32 w-32 overflow-clip mx-auto rounded-full">
                        ...
                        <input accept=".jpg,.jpeg,.png,.webp" wire:loading.attr="disabled" id="photo" wire:model="photo"
                            dusk="add_photo_field" type="file" hidden>
                        ...
                        <div class="   max-w-[90%] grid h-auto">
                            <div x-show="!editing">
                                <h4 dusk="form_group_name_when_not_editing"
                                    class="font-medium  break-all   whitespace-pre-line   text-2xl ">{{ $groupName }} </h4>
                            </div>
                ...
                <section class=" px-8 py-4 ">
                    <div @dusk="edit_description_section" x-data="{ editing: false }" @click.outside="editing=false"
                        ...
                        <span class="col-span-11">
                            ...
                            <textarea x-cloak maxlength="501" x-show="editing" id='description' type="text"
    ...
    <section class="my-4 text-left space-y-3">
        ...
        <x-wirechat::actions.open-modal component="wirechat.chat.group.members" conversation="{{ $conversation?->id }}"
    ...
    <footer class="flex flex-col justify-start w-full">
        ...
        @if ($authIsOwner)
            ...
            <button wire:confirm="{{ __('wirechat::chat.group.info.actions.delete_group.confirmation_message') }}"
                ...
                <p class="dark:text-white/60 text-sm text-gray-600/80">
                    @lang('wirechat::chat.group.info.actions.delete_group.helper_text')</p>
            </button>
            {{-- Permissions --}}
            <div>
