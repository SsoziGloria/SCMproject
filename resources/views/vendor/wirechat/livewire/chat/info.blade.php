<div id="info-modal" class="bg-[var(--wc-light-primary)] dark:bg-[var(--wc-dark-primary)]      min-h-screen">
    ...
    <section
        class="flex gap-4 z-10  items-center p-3 sticky top-0 bg-[var(--wc-light-primary)] dark:bg-[var(--wc-dark-primary)]   ">
    ...
    <section class="flex flex-col justify-start w-full">
        ...
        <button wire:confirm="{{ __('wirechat::chat.info.actions.delete_chat.confirmation_message') }}"
            ...
            class=" w-full cursor-pointer py-4 px-8 hover:bg-[var(--wc-light-secondary)] dark:hover:bg-[var(--wc-dark-secondary)] transition  flex gap-3 items-center text-red-500">
