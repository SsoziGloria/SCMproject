...
<div {{-- We use style here to make it easy for dynamic and safe injection --}} @style([
    'background-color:var(--green-chat)' => $belongsToAuth == true
]) @class([
    ...
    <pre class="whitespace-pre-line tracking-normal text-black md:text-base dark:text-black lg:tracking-normal"
        style="font-family: inherit;">
    {{$message?->body}}
</pre>

    {{-- Display the created time based on different conditions --}}
    <span @class(['text-[11px] ml-auto ', 'text-gray-700 dark:text-dark' => !$belongsToAuth, 'text-dark' => $belongsToAuth])>
        @php
