    ...
    <div x-data="WireChatModal()" x-on:close.stop="setShowPropertyTo(false)"
        ...
        <div class="flex items-end  justify-center min-h-screen px-4 pt-4 pb-10 text-center sm:block sm:p-0">
            ...
            <div x-show="show && showActiveModalComponent" x-transition:enter="ease-out duration-300"
                ...
                class="inline-block rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle w-full sm:max-w-lg"
                id="chat-dialog-container" x-trap.noscroll.inert="show && showActiveModalComponent" aria-modal="true">
                @forelse($components as $id => $component)
                    <div x-show.immediate="activeModalComponent == '{{ $id }}'" x-ref="{{ $id }}" wire:key="{{ $id }}">
