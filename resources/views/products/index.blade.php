            ...
            <table class="table table-bordered table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <a href="{{ route('products.create') }}" class="btn btn-primary"><i class="bi bi-plus-circle" class="btn btn-sm btn-primary ms-2"><i class="bi bi-plus-circle"></i> Add Product</a>
                        </div>    
                        </td>
                    </tr>
                    @endforelse
