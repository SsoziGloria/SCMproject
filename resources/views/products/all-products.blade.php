            ...
            <div class="row g-3">
              ...
              <div class="col-md-3">
                ...
                <select class="form-select" id="stock" name="stock">
                  ...
                  <option value="out-of-stock" {{ request('stock')=='out-of-stock' ? 'selected' : '' }}>Out of Stock
                  </option>
                </select>
              </div>
            </div>
              ...
              <tbody>
                ...
                <tr data-product-id="{{ $product->id }}">
                  ...
                  <td>
                    @php
                    $stockClass = 'success';
                    if ($product->stock <= 10) $stockClass='danger' ; elseif ($product->stock <= 50)
                        $stockClass='warning' ; @endphp <span class="badge bg-{{ $stockClass }}">{{ $product->stock
                        }}</span>
                        @if($product->inventories_sum_quantity && $product->inventories_sum_quantity != $product->stock)
                        <small class="text-muted d-block">({{ $product->inventories_sum_quantity }} in
                          inventory)</small>
                        @endif
                  </td>
                  <td>
