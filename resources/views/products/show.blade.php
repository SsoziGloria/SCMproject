...
<div class="container-fluid py-4">
    ...
    <div class="row mb-4 align-items-center">
        ...
        <div class="col-md-6 text-end">
            @if(auth()->user()->role === 'admin' || (auth()->user()->role === 'supplier' && auth()->user()->id ===
            $product->supplier_id))
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if($product->stock <= 5 && $product->stock > 0)
                                            ...
                                            @elseif($product->stock <= 0) <span class="badge bg-danger ms-2">Out of
                                                Stock</span>
                                                @endif
                                    </td>
                                </tr>
                        ...
                        <div class="col-md-6">
                            ...
                            <table class="table table-borderless">
                                <tr>
                                    ...
                                    <td>
                                        @if($product->supplier)
                                        {{-- <a href="{{ route('suppliers.show', $product->supplier->supplier_id) }}">
                                            --}}
